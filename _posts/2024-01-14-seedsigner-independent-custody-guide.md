---
title: SeedSigner Independent Custody Guide
...
![Era 3](/assets/img/seedsigner-guide-images/era_3.png){: width="600" }
...
### Necessary Items:
- A webcam-equipped computer running Sparrow bitcoin Wallet ([https://sparrowwallet.com](https://sparrowwallet.com))
- An assembled SeedSigner bitcoin signing device ([https://seedsigner.com](https://seedsigner.com))
...
"Nunchuk" ([https://nunchuk.io](https://nunchuk.io))
"Keeper" ([https://bitcoinkeeper.app](https://bitcoinkeeper.app))
...
![Keys](/assets/img/seedsigner-guide-images/keys.jpg){: width="300" }
...
![Specter DIY](/assets/img/seedsigner-guide-images/specter_diy.png)
...
![Early SeedSigner](/assets/img/seedsigner-guide-images/early_seedsigner.png)
...
![SeedSigner Components](/assets/img/seedsigner-guide-images/seedsigner_components.jpeg)
...
![Flagship](/assets/img/seedsigner-guide-images/flagship.png)
...
**A final thought on these criticisms/vulnerabilities, and on higher level threat modeling:** If you are attempting to mitigate state-level threats that have the ability to covertly compromise entire hardware and software supply chains, please reference the graphic below that was taken from The Hitchhiker’s Guide to Online Anonymity (see: [https://anonymousplanet.org/guide.html](https://anonymousplanet.org/guide.html)). **All** hardware devices are vulnerable to this level of interference, and corporate hardware wallets that are purpose-built and marketed/distributed specifically to secure private keys would be a much more productive target for the extensive resources required to successfully execute such an attack.

![Hitchhiker’s Guide](/assets/img/seedsigner-guide-images/hitchhikers_guide.jpeg)
...
![Raspberry Pi Zero v1.3](/assets/img/seedsigner-guide-images/rpi_zero_v1_3.PNG)
...
[https://github.com/DesobedienteTecnologico/rpi_disable_wifi_and_bt_by_hardware](https://github.com/DesobedienteTecnologico/rpi_disable_wifi_and_bt_by_hardware)
...
[https://www.waveshare.com/1.3inch-lcd-hat.htm](https://www.waveshare.com/1.3inch-lcd-hat.htm)
...
![Waveshare Hat](/assets/img/seedsigner-guide-images/waveshare_hat.PNG)
...
![Pi Camera](/assets/img/seedsigner-guide-images/picam.PNG)
...
![Zero Camera](/assets/img/seedsigner-guide-images/zerocam.PNG)
...
[https://github.com/SeedSigner/seedsigner/tree/dev/enclosures](https://github.com/SeedSigner/seedsigner/tree/dev/enclosures)
...
![Enclosure Photo](/assets/img/seedsigner-guide-images/enclosure_photo.png)
...
![Compact Build](/assets/img/seedsigner-guide-images/compact_build.png)
...
(check this source for more information: [https://sparrowwallet.com/docs/faq.html#how-can-i-run-testnet](https://sparrowwallet.com/docs/faq.html#how-can-i-run-testnet))
...
- [https://1209k.com/bitcoin-eye/ele.php?chain=tbtc](https://1209k.com/bitcoin-eye/ele.php?chain=tbtc)
...
![Create Seed From Image](/assets/img/seedsigner-guide-images/seedsigner_create_seed_from_image.png){: width="750" }
...
![Navigate to SeedQR](/assets/img/seedsigner-guide-images/seedsigner_navigate_to_seedqr.png){: width="600" }
...
![Transcription UI](/assets/img/seedsigner-guide-images/seedsigner_transcription_ui.png){: width="750" }

Several user-printable options for documenting seed phrases and SeedQRs can be found in the official repo's “docs” folder ([https://github.com/SeedSigner/seedsigner/tree/main/docs](https://github.com/SeedSigner/seedsigner/tree/main/docs))

Here is an example of a seed phrase and transcribed SeedQR using one of the forms available in the repo:

![Seed QR Card Example](/assets/img/seedsigner-guide-images/seed_qr_card_example.png){: width="600" }
...
![Switch to Testnet](/assets/img/seedsigner-guide-images/sparrow_switch_testnet.png){: width="350" }

With Sparrow operating in testnet mode, to create the wallet navigate to File —> New Wallet

![New Wallet](/assets/img/seedsigner-guide-images/sparrow_new_wallet.png){: width="350" }

Give the wallet an appropriate name:

![Name Wallet](/assets/img/seedsigner-guide-images/sparrow_name_wallet.png){: width="550" }

Select “Multi signature” as the wallet Policy Type

![Select Multisig](/assets/img/seedsigner-guide-images/sparrow_select_multisig.png){: width="750" }

Making this selection will make the configurable option “Cosigners” appear in the upper righthand corner of the window:

![Cosigners](/assets/img/seedsigner-guide-images/sparrow_cosigners.png){: width="750" }
...
![Select Airgapped Device](/assets/img/seedsigner-guide-images/sparrow_select_airgapped_device.png){: width="450" }
...
![Testnet](/assets/img/seedsigner-guide-images/testnet.png){: width="750" }
...
![Export Xpub 1](/assets/img/seedsigner-guide-images/xpub1.png){: width="750" }

... Sparrow —> Export Xpub

![Export Xpub 2](/assets/img/seedsigner-guide-images/xpub2.png){: width="750" }
...
![Key 1 Entered](/assets/img/seedsigner-guide-images/key_1_entered.png){: width="750" }
...
![All Keys Entered](/assets/img/seedsigner-guide-images/all_keys_entered.png){: width="750" }
...
![Password Prompt](/assets/img/seedsigner-guide-images/password_prompt.png)
...
![File Export](/assets/img/seedsigner-guide-images/file_export.png){: width="300" }
...
![Specter Export](/assets/img/seedsigner-guide-images/specter_export.png){: width="500" }
...
![Wallet Descriptor](/assets/img/seedsigner-guide-images/wallet_descriptor.png){: width="500" }
...
![Receive](/assets/img/seedsigner-guide-images/receive.png){: width="750" }
...
![Send](/assets/img/seedsigner-guide-images/send.png){: width="750" }
...
![Transaction Overview](/assets/img/seedsigner-guide-images/txn.png){: width="750" }
...
![Finalize Options](/assets/img/seedsigner-guide-images/txn2.png){: width="750" }

From these options, first select "Show QR", which will bring up a window displaying an animated QR code:

![Animated PSBT QR](/assets/img/seedsigner-guide-images/txn_gif.gif){: width="500" }
...
![Scan PSBT In](/assets/img/seedsigner-guide-images/txn_scan.gif){: width="500" }
...
![PSBT Scan In](/assets/img/seedsigner-guide-images/ss_txn_scan_in.png){: width="750" }
...
![Sign PSBT](/assets/img/seedsigner-guide-images/sign_psbt.png){: width="250" }
...
![Signed PSBT QRs](/assets/img/seedsigner-guide-images/signed_psbt_qrs.gif){: width="400" }
...
![Scan PSBT Back In](/assets/img/seedsigner-guide-images/ss_psbt_back_in.gif){: width="500" }
...
![Sparrow Signature 1](/assets/img/seedsigner-guide-images/sparrow_sig_1.png){: width="750" }
...
![Sparrow Signature 2](/assets/img/seedsigner-guide-images/sparrow_sig_2.png){: width="750" }
