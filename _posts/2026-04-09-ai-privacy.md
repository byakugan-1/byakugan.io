...
This is where things get more interesting. Services like PayPerQ and NanoGPT allow you to pay with privacy-preserving cryptocurrencies like Bitcoin via Lightning, post-Whirlpool coinjoined Bitcoin, or Monero.
...
- **Policy changes mid-cycle**: NanoGPT, for example, has changed what models are avaliable in its subscription multiple times during billing cycles. Understandable from a business perspective, but very frustrating as a customer.
